...
double IntegratedLuminosity13TeV16             = 865.6; // pb
...
string IntegratedLuminosityFromE(double SQRTS_){
  ...
  if(SQRTS_==13 || SQRTS_==1315)      sprintf(LumiText,"%1.1f fb^{-1} (%1.0f TeV)", 0.001*IntegratedLuminosity13TeV15, 13.0);
  if(SQRTS_==1316)                    sprintf(LumiText,"%1.1f fb^{-1} (%1.0f TeV)", 0.001*IntegratedLuminosity13TeV16, 13.0);
  if(SQRTS_==131615 || SQRTS_==131516) sprintf(LumiText,"2016: %1.1f fb^{-1}   2015: %1.1f fb^{-1} (%1.0f TeV)", 0.001*IntegratedLuminosity13TeV16, 0.001*IntegratedLuminosity13TeV15, 13.0);
